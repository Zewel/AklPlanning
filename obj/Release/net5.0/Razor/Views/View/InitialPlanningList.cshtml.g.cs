#pragma checksum "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4767795d5a0901023d100f450ca8ddafd53d609e"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_View_InitialPlanningList), @"mvc.1.0.view", @"/Views/View/InitialPlanningList.cshtml")]
...
#nullable disable
#nullable restore
#line 2 "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml"
using System.Data;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4767795d5a0901023d100f450ca8ddafd53d609e", @"/Views/View/InitialPlanningList.cshtml")]
    ...
    public class Views_View_InitialPlanningList : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<System.Data.DataSet>
    {
        ...
        <div class=""col-md-12"">
            <div class=""card card-success"">
                <div class=""card-header"">
                    <div class=""row"">
                        <div class=""col-md-1"">
                            <label for=""dllTaskType"">Planning Year</label>
                        </div>
                        <div class=""col-md-3"">
                            <select class=""form-control select2"" style=""width: 100%;"" onchange=""InitialPlanningList()"" id=""dllYear"">
                            </select>
                        </div>
...
");
            ...
            BeginWriteAttribute("onchange", " onchange=\"", 6847, "\"", 6858, 0);
            EndWriteAttribute();
            WriteLiteral(">\r\n                                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4767795d5a0901023d100f450ca8ddafd53d609e10989", async() => {
            ...
            BeginWriteAttribute("onchange", " onchange=\"", 7331, "\"", 7342, 0);
            EndWriteAttribute();
            WriteLiteral(@">
                                </select>
                            </div>
            ...
            BeginWriteAttribute("onchange", " onchange=\"", 7735, "\"", 7746, 0);
            EndWriteAttribute();
            WriteLiteral(">\r\n                                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4767795d5a0901023d100f450ca8ddafd53d609e13301", async() => {
        ...
        var table;
         function InitialPlanningList() {
           ...
           ");
                WriteLiteral("  \r\n             var urlpath = \'");
#nullable restore
#line 278 "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml"
                       Write(Url.Action("InitialPlanningPartial", "PartialView"));
...
#nullable disable
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    for (let i = 1; i <= 8; i++) {
                         ...
                         table = $('#InitalPlanning_' + i).DataTable({
                            ""columnDefs"": [
                            ...
                            //    var api = this.api();
                        ");
                WriteLiteral(@"    //    var rows = api.rows({ page: 'current' }).nodes();
                            //    var last = null;
        ...
        function ShowStlData(data) {
             ...
             var urlpath = '");
#nullable restore
#line 351 "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml"
...
#nullable disable
        ...
        function ShowStlInfo() {
            var styleNo = $('#styleId').val();
             var urlpath = '");
#nullable restore
#line 372 "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml"
        ...
        function ActionForSlot(data) {
            ...
            $('#InitalPlanning_'+data +' tbody tr').each(function (index) {
                if ($(this).find('.checkBoxCls').prop('checked')) {
                    ...
                    //var pro");
                WriteLiteral(@"ductionPeraMcn = $(this).find('.stlNo').text();
                    ...
                    tableBodyThreadPositionSize.append('<tr id=""tr_' + sl + '"">'
                        + '<td style=""display:none;"">  <label  style=""width: 150px"" class=""planningSlotDetailsId"" name=""planningSlotDetailsId"" id = ""planningSlotDetailsId' + sl.to");
                WriteLiteral(@"String() + '""  > ' + 0 + ' </label ></td>'
                 ...
                 ");
                WriteLiteral(@"       + '<td style=""""><label name=""ShipDate"" class=""exFactoryDay""  id = ""ShipDate' + sl.toString() + '""  > ' + shipDate + ' </label ></td>'

                        + '<td style=""""> <label  style=""width: 120px"" class=""alreadyKnitt"" name=""alreadyKnitt"" id = ""alreadyKnitt' + sl.toString() + '""  > ' + alreadyKnitt + ' </label ></td>'
                        + '<td style=""""><input  style=""width: 70px;"" type=""number"" class=""remainingQty"" id=""remaining' + sl.toString() + '"" onchange = ""CalculateMachine( $(this))""  value=""' + remainingQty + '""     /></td>'
                        ...
                        + '<td style=""""><input type=""number"" style=");
                WriteLiteral(@"""width: 67px;"" class=""reqMachine"" name=""reqMachine""  id=""reqMachine' + sl.toString() + '"" value=""""     /></td>'
                        ...
                        + '<td style=""""><input style=""width: 120px"" class=""trailDate datepicker"" name=""TrailDate""  type=""text"" id=""Comments' + sl.toString() + '"" value=""""  /></td>'
                        ...
                        + '<td style=""""><input  style=""width: 70px;"" class=""remarks"" readonly type=""text"" name=""stltype"" id=""PPM' + sl.toString() + '"" val");
                WriteLiteral(@"ue=""' + stltype+'""     /></td>'
        ...
        function GetFactory(elamentName) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.length > 0) {
                ");
                WriteLiteral(@"        $('#' + elamentName + '').empty();
...
");
        ...
        function GetSlotDate() ");
            ...
            if (isNaN(yearId) || isNaN(factoryId) || isNaN(gaugeId) || isNaN(leadTime)) {
               ...
               ");
                WriteLiteral(@"         $('#machineQty').html(""Total Machine Qty is:"" + result[0].TotalMachineQty);
        ...
        function GetStatDateReCalculate() {
            ...
            if ($('#manualFromDate').prop(""checked"") == true) {
                ...
                if (isNaN(yearId) || isNaN(factoryId) || isNaN(gaugeId)) {
                    ...
                    $.ajax({
                        url: apiHeader + 'api/CreateSlot/GetLastDateForPlanning/' + yearId + '/' + factoryId + '/'");
                WriteLiteral(@" + brandId + '/' + gaugeId,
                        type: ""GET"",
                        dataType: ""json"",
                        async: false,
                        success: function (result) {
        ...
        function CalculationForMachine(");
            ...
            $.ajax({
                url: apiHeader + 'api/InitialPlanning/GetWorkableMuniteFCalCuMcn/' + startDate + '/' + endDate + '/'+ year + '/' + leadTime,
                type: ""GET"",
                dataType: ""json"",
                async: false,
                success: function (result) {
  ...
  ");
        ...
        function daysdifference(firstDate, secondDate) {
            ...
            var millisBetween = startDay.getTime() - endDay.g");
                WriteLiteral(@"etTime();
        ...
        function CreateSlot() {
            ...
            //$('#myTable tbody tr').each(function (index) {
            //    if ($(this).find('.trailDate').val() == """" || $(this).find('.trailDa");
                WriteLiteral(@"te').val() == null) {
          ...
          ");
                WriteLiteral(@"      $('#myTable tbody tr').each(function (index) {
                    pOCod = parseInt($(this).find('.poCodc').text());
                    ...
                    if (parseInt(requiredMachine) == 0) {
                        ");
                WriteLiteral(@"toastr.warning('Require Machine is ivalid. Please Check');
                        return false;
                    }
...
#nullable restore
#line 891 "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml"
...
#nullable disable
        ...
        function CalculateMachine(element) {
            ...
            if (isNaN(FactoryId) || isNaN(Leaddate)) {
                ...
                element.closest(""tr"").find(""input[class=remainingQty]"").val((poQty - Alreadyk");
                WriteLiteral(@"ntQty));
                return false;
            }
            ...
            element.closest(""tr"").find(""inpu");
                WriteLiteral(@"t[class=productionPerDay]"").val(reqMcn * productionPerMcn);
            var totalMcnQty = 0;
  ...
  ");
        ...
        function SearchGRN(data) {
             ...
             var urlpath = '");
#nullable restore
#line 974 "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml"
...
#nullable disable
        ...
        function SearchTAndA(data) {
             ...
             var urlpath = '");
#nullable restore
#line 993 "E:\Professional\MyProjects\CoreWork\Bitbucket\BitBucketLive\SweaterPlanLive\aklplanning\Views\View\InitialPlanningList.cshtml"
